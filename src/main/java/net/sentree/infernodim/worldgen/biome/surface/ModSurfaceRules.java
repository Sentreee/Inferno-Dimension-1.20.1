...
public class ModSurfaceRules {
    private static final SurfaceRules.RuleSource ASH_BLOCK_UNDER = makeStateRule(ModBlocks.ASH_BLOCK.get());
    ...
    public static SurfaceRules.RuleSource makeRules() {
        ...
        return SurfaceRules.sequence(
                SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(ModBiomes.INFERNO_BIOME),
                        ...
                        SurfaceRules.ifTrue(SurfaceRules.ON_CEILING, ASH_BLOCK)),
                SurfaceRules.ifTrue(SurfaceRules.UNDER_CEILING, ASH_BLOCK),
                //SurfaceRules.ifTrue(SurfaceRules.UNDER_FLOOR, ASH_BLOCK),
                //SurfaceRules.ifTrue(SurfaceRules.DEEP_UNDER_FLOOR, ASH_BLOCK),
                //SurfaceRules.ifTrue(SurfaceRules.VERY_DEEP_UNDER_FLOOR, ASH_BLOCK),
                SurfaceRules.ifTrue(SurfaceRules.abovePreliminarySurface(), ASH_BLOCK),
                SurfaceRules.ifTrue(SurfaceRules.hole(), ASH_BLOCK),
                SurfaceRules.ifTrue(SurfaceRules.isBiome(), ASH_BLOCK),
                SurfaceRules.ifTrue(SurfaceRules.temperature(), ASH_BLOCK),
                SurfaceRules.ifTrue(SurfaceRules.steep(), ASH_BLOCK)
        );
    }
